...
public class TestTableMetadata {
  ...
  public void testJsonConversion() throws Exception {
    ...
    SnapshotOperations snapshotOperations =
        ImmutableSnapshotOperations.builder()
            .initialSnapshots(Arrays.asList(previousSnapshot, currentSnapshot))
            .initialRefs(refs)
            .build();
  ...
  public void testMainWithoutCurrent() throws IOException {
    ...
    SnapshotOperations snapshotOperations =
        ImmutableSnapshotOperations.builder()
            .initialSnapshots(ImmutableList.of(snapshot))
            .initialRefs(refs)
            .build();
  ...
  public void testBranchSnapshotMissing() {
    ...
    SnapshotOperations snapshotOperations =
        ImmutableSnapshotOperations.builder().initialRefs(refs).build();
