  ...
  protected DataFile file6() {
    return new TestDataFile(
        ...
        BaseContentStats.builder()
            ...
            .withFieldStats(
                BaseFieldStats.builder().fieldId(101).valueCount(5L).nullValueCount(5L).build())
            .withFieldStats(BaseFieldStats.builder().fieldId(102).valueCount(5L).build())
            .withFieldStats(
                BaseFieldStats.builder().fieldId(103).valueCount(5L).nullValueCount(5L).build())
            .withFieldStats(
                BaseFieldStats.builder().fieldId(104).valueCount(5L).nullValueCount(5L).build())
            .withFieldStats(
                BaseFieldStats.builder().fieldId(105).valueCount(5L).nullValueCount(5L).build())
            .build());
  }
}
