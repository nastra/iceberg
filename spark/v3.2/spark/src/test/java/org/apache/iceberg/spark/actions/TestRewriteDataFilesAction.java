...
public class TestRewriteDataFilesAction extends SparkTestBase {
  ...
  private RewriteDataFiles basicRewrite(Table table) {
    ...
    table.refresh();
    return actions()
        .rewriteDataFiles(table, tableLocation)
  ...
  public void testInvalidAPIUsage() {
    ...
    AssertHelpers.assertThrows(
        ...
        IllegalArgumentException.class,
        "Cannot set strategy",
        () -> actions().rewriteDataFiles(table, tableLocation).binPack().sort());

    AssertHelpers.assertThrows(
        "Should be unable to set Strategy more than once",
        IllegalArgumentException.class,
        "Cannot set strategy",
        () -> actions().rewriteDataFiles(table, tableLocation).sort().binPack());
